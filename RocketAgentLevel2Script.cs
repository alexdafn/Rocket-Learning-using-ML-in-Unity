...
public class RocketAgentLevel2Script : Agent
{
    ...
    {
        RandomLandingPadRepositionOnTheRight();//Level2
    ...
    // Level2
    // Random reposition of the LandingPad on right side 
    private void RandomLandingPadRepositionOnTheRight()
    {
        randomNumber= Random.Range(5,45);//LEVEL2
