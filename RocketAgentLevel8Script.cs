...
public class RocketAgentLevel8Script : Agent
{
    ...
    // Level8 used to get observation about the obstacles' position
    ...
    public override void OnActionReceived(float[] vectorAction)
    {
        ...
        // Penalty when the agent gets past the x coordinate of the LandingPad
    ...
    private void RandomLandingPadReposition()
    {
        ...
        randomNumberObs1X= Random.Range(5,45); // Level8
        randomNumberObs1Y= Random.Range(0,30); // Level8
        // Level8 
        ...
        randomNumberObs2X= Random.Range(5,45); // Level8
        randomNumberObs2Y= Random.Range(0,30); // Level8
        // Level8 
